...
class RecordTodayAdapter(val context: Context, val viewModel: RecordViewModel) :ListAdapter<Record,RecordTodayAdapter.ViewHolder>(RecordDiffUtil) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecordTodayAdapter.ViewHolder {
        val binding = ItemRecordTodayBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: RecordTodayAdapter.ViewHolder, position: Int) {
