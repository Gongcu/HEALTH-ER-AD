...
public class RecyclerAdapter_cal_child extends RecyclerView.Adapter<RecyclerAdapter_cal_child.ItemViewHolder>{
    ...
    public void setAdpaterListener(AdapterListener adpaterListener){
        this.listener = adpaterListener;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapter_cal_child.ItemViewHolder holder, int position) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapter_cal_child.ItemViewHolder holder, int position, @NonNull List<Object> payloads) {
        if (payloads.isEmpty()) {
