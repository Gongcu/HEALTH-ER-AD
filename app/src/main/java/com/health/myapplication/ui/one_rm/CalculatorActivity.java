...
import com.health.myapplication.view_pager.CalculatorContentsPagerAdapter;

public class CalculatorActivity extends AppCompatActivity {
    private Context mContext;
    private TabLayout mTabLayout;
    private ViewPager mViewPager;
    private CalculatorContentsPagerAdapter mContentsPagerAdapter;
...
/*
        ...
        mContentsPagerAdapter = new CalculatorContentsPagerAdapter(
